...
$app->post("/register", function (){
	...
	if(User::checkLoginExist($_POST['email']) === true){
		User::setErrorRegister("Este e-mail já está sendo utilizado.");
		header("Location: /login");
		exit;
	}
...
$app->get("/boleto/:idorder", function ($idorder){
	...
	$dadosboleto["endereco1"] = $order->getdesaddress() . " " . $order->getdesdistrict() . " " . $order->getdescity() . " " . $order->getdesstate(). " " . $order->getdescountry();
	...
	// SEUS DADOS
	$dadosboleto["identificacao"] = "panzaCode";
...
$app->post("/profile/change-password", function (){
	...
	if($_POST['current_pass'] === $_POST['new_pass']){
		User::setError("A nova senha precisa ser diferente.");
		header("Location: /profile/change-password");
		exit;
	}
	...
	if ($_POST['new_pass'] != $_POST['new_pass_confirm']) {
		...
		User::setError("A senha nova está diferente da confirmação");
		header("Location: /profile/change-password");
		exit;
	}
